...
import com.bagasbest.fundamental2.academy.ui.detail.DetailCourseActivity
import com.bagasbest.fundamental2.databinding.ItemAcademyBinding
...
class AcademyAdapter : RecyclerView.Adapter<AcademyAdapter.CourseViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CourseViewHolder {
        val itemsAcademyBinding = ItemAcademyBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class CourseViewHolder(private val binding: ItemAcademyBinding) : RecyclerView.ViewHolder(binding.root) {
