...
class AcademyAdapter : RecyclerView.Adapter<AcademyAdapter.CourseViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CourseViewHolder {
        val binding = ItemAcademyBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class CourseViewHolder(private val binding: ItemAcademyBinding) : RecyclerView.ViewHolder(binding.root) {
