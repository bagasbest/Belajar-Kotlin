package com.bagasbest.berepo.provider
...
import com.bagasbest.berepo.database.DatabaseContract.AUTHORITY
...
class UserProvider : ContentProvider() {
    ...
    init {
        // content://com.bagasbest.berepo/user
        sUriMatcher.addURI(AUTHORITY, TABLE_NAME, USER)

        // content://com.bagasbest.berepo/user/id
